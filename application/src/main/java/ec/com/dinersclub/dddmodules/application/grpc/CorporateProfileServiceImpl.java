...
@GrpcService
public class CorporateProfileServiceImpl extends ec.com.dinersclub.dddmodules.application.grpc.CorporateProfileServiceGrpc.CorporateProfileServiceImplBase {
	
	private static final Logger log = LoggerFactory.getLogger(CorporateProfileServiceImpl.class.getName());
