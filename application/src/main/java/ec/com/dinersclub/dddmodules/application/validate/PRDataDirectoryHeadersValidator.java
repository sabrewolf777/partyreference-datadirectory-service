...
public class PRDataDirectoryHeadersValidator implements ConstraintValidator<ValidPRDataDirectoryHeaders, HttpHeaders> {

    @Override
    public void initialize(ValidPRDataDirectoryHeaders constraintAnnotation) {
    }
